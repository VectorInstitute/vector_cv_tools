...
from model_build_utils import (r3d_18_dropout, mc3_18_dropout,
                               r2plus1d_18_dropout)
...
class R3D18(nn.Module):
    ...
    def __init__(self,
        ...
        if dropout_prob > 0:
            model = r3d_18_dropout(progress=False, dropout_prob=dropout_prob)
        else:
...
class Res2P1Model(nn.Module):
    ...
    def __init__(self,
        ...
        if dropout_prob > 0:
            model = r2plus1d_18_dropout(progress=False,
...
class MC3_18(nn.Module):
    ...
    def __init__(self,
        ...
        if dropout_prob > 0:
            model = mc3_18_dropout(progress=False, dropout_prob=dropout_prob)
        else:
