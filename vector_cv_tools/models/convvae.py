"""Example usage
from vector_cv_tools.models import ConvVAE
model = ConvVAE()

# you can also put whatever checkpoint you want here
checkpoint = torch.load("/checkpoint/gshensvm/cv_models_updated/model_500.pt")

# for the checkpoint in that directory, the model state dictionary is at
# checkpoint["model"]
